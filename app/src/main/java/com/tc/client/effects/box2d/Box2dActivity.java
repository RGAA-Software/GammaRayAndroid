package com.tc.client.effects.box2d;
...
import com.tc.client.effects.box2d.Tools.GiftParticleContants;
...
public class Box2dActivity extends FragmentActivity implements AndroidFragmentApplication.Callbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.sendStarBtn).setOnClickListener(v -> {
			m_weakHandler.postDelayed(m_runnableSendStar, 50);
		});

	    findViewById(R.id.crazyModeBtn).setOnClickListener(v-> {
    ...
    public class SystemReceiveBroadCast extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("Main", "SystemReceiveBroadCast[^^^^^^^]play Particle Receive: " + intent.getAction());
